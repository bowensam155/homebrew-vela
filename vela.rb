...
class Vela < Formula
  ...
  # mitmproxy has many transitive dependencies.
  # The full resource list is generated by `poet -f vela-cli` after publishing.
  # Placeholder — update before submitting to the tap.
  resource "mitmproxy" do
    url "https://files.pythonhosted.org/packages/source/m/mitmproxy/mitmproxy-10.3.1.tar.gz"
    sha256 "PLACEHOLDER_UPDATE_AFTER_PYPI_PUBLISH"
  end
